...
TABLE_DISPARO_EVENTOS = f"{CATALOG}.{SCHEMA_EVENTOS}.disparo_eventos"
TABLE_DISPARO_AVULSO = f"{CATALOG}.{SCHEMA_ENG}.disparo_avulso"
TABLE_CONFIG_OTIMIZACAO = f"{CATALOG}.{SCHEMA_ENG}.config_otimizacao"
TABLE_OTIMIZACAO_VARIANTE = f"{CATALOG}.{SCHEMA_ENG}.otimizacao_variante"
TABLE_OTIMIZACAO_RESULTADO = f"{CATALOG}.{SCHEMA_ENG}.otimizacao_resultado"
TABLE_OTIMIZACAO_HISTORICO = f"{CATALOG}.{SCHEMA_ENG}.otimizacao_historico"
